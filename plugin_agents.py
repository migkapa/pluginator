...
def get_plugin_spec_agent():
    """Create plugin specification agent with current model."""
    return Agent(
...
def get_file_generator_agent():
    """Create file generator agent with current model."""
    return Agent(
...
def get_compliance_agent():
    """Create compliance agent with current model."""
    return Agent(
...
def get_testing_agent():
    """Create testing agent with current model."""
    return Agent(
...
def get_plugin_manager_agent():
    """Create plugin manager agent with current model and dynamic sub-agents."""
    return Agent(
